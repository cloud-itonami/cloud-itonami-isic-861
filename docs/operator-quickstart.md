# Operator Quickstart — Hospital Activities - Coordination Only

Shortest path from clone to a verified local dry-run for **ISIC 861** (`cloud-itonami-isic-861`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-861.git
cd cloud-itonami-isic-861
```
...
- Blueprint governor key: `hospital-governor`
- Likely source path: `hospitalops.governor.cljc`
